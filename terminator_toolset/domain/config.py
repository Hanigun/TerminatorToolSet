...
DEFAULTS = {
    ...
    "mod_path": "",
    # саб-путь мода: папка вида <МОД>_ASSETS с чистыми текстурами рядом
    # с корнем мода. Поиск моделей/текстур идёт по слоям мода, затем
    # оверлея — оба корня видны программе как одно целое (domain/modroots)
    "mod_overlay_path": "",
